...
1. Go to home directory and clone repository from github: `cd ~ && git clone https://SergeyIvanovDevelop@github.com/SergeyIvanovDevelop/Golography-Chat`

**Step 2**<br>

2. Open the `Android` application code `Portal` module from the `golography-client` branch in `Android Studio` 
